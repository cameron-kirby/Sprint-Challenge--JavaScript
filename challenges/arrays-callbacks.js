...
let dino2 = {name: "stegosaurus", diet: "herbivorous", weight: "2000kg", length: "9m", period: "Late Jurassic"};

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
let dino3 = {name: "velociraptor", diet: "carnivorous", weight: "15kg", length: "1.8m", period: "Late Cretaceous"};
...
console.log(`The ${dino3.name} was ${dino1.diet}!`);

// How long was a stegosaurus?
console.log(`The ${dino2.name} was ${dino1["length"]} long!`);
